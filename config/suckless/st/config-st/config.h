...
static const char *colorname[] = {
	...
	"#cc241d",
	"#478D78",   /*having executible permissions [on tilix, left-Green]*/
	"#A17A5E",	 /*current user and environment(git/conda) eg [lazy@boy] [~/.config/suckless/st/config-st ‹master*›], here lazy and ‹master*› will be coloured out*/
	"#00FFFF",   /*folder color*/
	"#B56161",
	"#689d6a",
	"#a89984",
